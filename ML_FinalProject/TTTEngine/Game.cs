        ...
        */
        ...
        public int Place(int tile, bool player)
        {
            ...
            if (this.tiles[81 + this.focus_board] == 0 && this.tiles[tile + 9 * this.focus_board] == 0)
            {
                ...
                // Tied the board
                if (this.turns[this.focus_board] == 9)
                { 
                    return -3;
                }
            ...
            for (int condition = 0; condition < 8; condition++)
            {
                ...
                { 
                    case 0: // Row across top
                        if (this.tiles[offset] == player_const && this.tiles[offset + 1] == player_const
                                && this.tiles[offset + 2] == player_const)
                        {
                            ret = 1;
                        }
                        break;
                    case 1: // Row across middle
                        if (this.tiles[offset + 3] == player_const && this.tiles[offset + 4] == player_const
                                && this.tiles[offset + 5] == player_const)
                        {
                            ret = 1;
                        }
                        break;
                    case 2: // Row across bottom
                        if (this.tiles[offset + 6] == player_const && this.tiles[offset + 7] == player_const
                                && this.tiles[offset + 8] == player_const)
                        {
                            ret = 1;
                        }
                        break;
                    case 3: // Column on left
                        if (this.tiles[offset] == player_const && this.tiles[offset + 3] == player_const
                                && this.tiles[offset + 6] == player_const)
                        {
                            ret = 1;
                        }
                        break;
                    case 4: // Column in middle
                        if (this.tiles[offset + 1] == player_const && this.tiles[offset + 4] == player_const
                                && this.tiles[offset + 7] == player_const)
                        {
                            ret = 1;
                        }
                        break;
                    case 5: // Column on right
                        if (this.tiles[offset + 2] == player_const && this.tiles[offset + 5] == player_const
                                && this.tiles[offset + 8] == player_const)
                        {
                            ret = 1;
                        }
                    ...
                    case 6: // Diagonal with negative slope
                        if (this.tiles[offset] == player_const && this.tiles[offset + 4] == player_const
                                && this.tiles[offset + 8] == player_const)
                        {
                            ret = 1;
                        }
                    ...
                    case 7: // Diagonal with positive slope
                        if (this.tiles[offset + 2] == player_const && this.tiles[offset + 4] == player_const
                                && this.tiles[offset + 6] == player_const)
                        {
                            ret = 1;
                        }
